...
<head>
  ...
  <title>404 Not Found — WFCS Auction</title>
...
<body class="bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 font-sans min-h-screen flex flex-col items-center justify-center px-6 transition-colors duration-300">
  <div class="text-center max-w-md">
    <p class="text-8xl font-black text-primary mb-4 tabular-nums">404</p>
    <h1 class="text-2xl font-bold text-slate-900 dark:text-white mb-2">Page Not Found</h1>
    <p class="text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">The page you're looking for doesn't exist or may have been moved.</p>
