...
<head>
  ...
  <title>500 Server Error — WFCS Auction</title>
...
<body class="bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 font-sans min-h-screen flex flex-col items-center justify-center px-6 transition-colors duration-300">
  <div class="text-center max-w-md">
    <p class="text-8xl font-black text-red-500 mb-4 tabular-nums">500</p>
    <h1 class="text-2xl font-bold text-slate-900 dark:text-white mb-2">Server Error</h1>
    <p class="text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">Something went wrong on our end. Please try again in a moment. If the problem persists, contact <a href="mailto:info@wellfoundation.org.uk" class="text-primary hover:underline">info@wellfoundation.org.uk</a>.</p>
